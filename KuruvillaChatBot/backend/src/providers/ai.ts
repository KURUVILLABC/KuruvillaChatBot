  ...
  private generateDigitalTwinResponse(userContent: string, systemPrompt: string): string {
    ...
    if (userContent.includes('experience') || userContent.includes('work') || userContent.includes('background') || userContent.includes('employment') || userContent.includes('job')) {
      const experience = [
        ...
        "My professional experience has focused on full-stack development and AI systems. I've worked as a software engineer building scalable backends with Node.js and engaging frontends with React. More recently, I've specialized in AI integration and building intelligent knowledge systems through increasingly complex projects.",
        "My professional experience started in full-stack development and evolved toward AI systems architecture. It includes backend development with modern frameworks like Node.js and Fastify, frontend development with React, and AI and LLM integration. Each role has built on the previous one, leading to my current focus on knowledge systems.",
        "In my professional experience as a software engineer, I've worked across the entire stack - from database design and backend APIs to interactive frontends. More recently, my focus has shifted toward AI systems and effectively integrating LLMs into applications. I love making AI systems practical and user-friendly."
      ];
