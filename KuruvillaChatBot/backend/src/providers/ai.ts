  ...
  private generateDigitalTwinResponse(
    ...
    if (userContent.includes('experience') || userContent.includes('work') || userContent.includes('background') || userContent.includes('employment') || userContent.includes('job')) {
      const experience = [
        ...
        "In my professional experience as a software engineer and full-stack developer, I've worked across the entire stack - from database design and backend APIs to interactive frontends. More recently, my focus has shifted toward AI systems and effectively integrating LLMs into applications. I love making AI systems practical and user-friendly."
      ];
